...
//using TinifyAPI; // 注释掉缺失的第三方库
using SixLabors.ImageSharp.Processing;
using SixLabors.ImageSharp;
using SixLabors.ImageSharp.Formats.Jpeg;
using System.Collections.Generic;
using System.Text.RegularExpressions;
using YF.ReferencePool;
...
namespace YF.EditorTools
{
    ...
    public class AtlasVariantSettings : AtlasSettings
    {
        ...
        {
            var settings = YF.ReferencePool.ReferencePool.Acquire<AtlasVariantSettings>();
    ...
    public class CompressTool
    {
        ...
        {
            // TinifyAPI库缺失，暂时返回false
            // 需要安装TinifyAPI NuGet包后取消注释以下代码
            /*
            ...
            */
            Debug.LogWarning("TinifyAPI库缺失，在线压缩功能暂不可用");
            return false;
        }
        ...
        {
            // SixLabors.ImageSharp库访问权限问题，暂时禁用
            // 需要正确配置SixLabors.ImageSharp包后取消注释以下代码
            /*
            ...
            */
            Debug.LogWarning("SixLabors.ImageSharp库访问权限问题，图片缩放功能暂不可用");
            return false;
        }
        /// <summary>
        /// 设置图片尺寸
        ...
        private static bool CompressJpgOffline(string imgFileName, string outputFileName)
        {
            ...
            */
            Debug.LogWarning("SixLabors.ImageSharp库访问权限问题，JPG压缩功能暂不可用");
            return false;
        }
        /// <summary>
        /// 使用pngquant压缩png图片
        ...
        public static SpriteAtlas CreateAtlasVariant(SpriteAtlas atlasMaster, AtlasVariantSettings settings)
        {
            ...
            var atlasVariantName = Path.Combine(Path.GetDirectoryName(atlasFileName), $"{Path.GetFileNameWithoutExtension(atlasFileName)}_Variant{GetAtlasExtensionV1V2()}");
