...
namespace YF.ReferencePool
{
    ...
    public static partial class ReferencePool
    {
        ...
        private static void InternalCheckReferenceType(Type referenceType)
        {
            ...
            {
                throw new ArgumentException("Reference type is not a non-abstract class type.", nameof(referenceType));
            }

            if (!typeof(IReference).IsAssignableFrom(referenceType))
            {
                throw new ArgumentException(string.Format("Reference type '{0}' is invalid.", referenceType.FullName), nameof(referenceType));
            }
        }
        ...
        private static ReferenceCollection GetReferenceCollection(Type referenceType)
        {
            if (referenceType == null)
            {
                throw new ArgumentNullException(nameof(referenceType), "ReferenceType is invalid.");
            }
