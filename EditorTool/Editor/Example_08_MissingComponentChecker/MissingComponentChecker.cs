...
namespace ToolKits
{
    ...
    {
        private const string PATH = "Assets/CodeWarehouse/EditorTool/Editor/Example_08_MissingComponentChecker/Prefabs";
        private const string PrefabNameColor = "#00FF00";
        private const string PathColor = "#0000FF";

        [MenuItem("Tools/Examples/CheckMissingComponent", priority = 8)]
