...
namespace ToolKits
{
    public class PreviewWindow : OdinEditorWindow
    {
        ...
        [MenuItem("Tools/Examples/PreviewWindow", priority = 9)]
        ...
        private void CleanupPreview()
        {
            ...
            if (null != _avatarPreview)
            {
                ...
                {
                    Debug.LogWarning($"Error during AvatarPreview cleanup: {ex.Message}");
                }
                finally
                {
                    _avatarPreview = null;
        ...
        {
            base.OnDisable();
            // 在OnDisable时也调用清理，确保PreviewRenderUtility被正确清理
            if (null != _avatarPreview)
            {
                try
                {
                ...
                {
                    Debug.LogWarning($"Error during AvatarPreview OnDisable: {ex.Message}");
                }
            }
        }
    }
