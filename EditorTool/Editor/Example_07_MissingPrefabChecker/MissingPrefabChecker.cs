...
namespace ToolKits
{
    ...
    {
        private const string PATH = "Assets/CodeWarehouse/EditorTool/Editor/Example_07_MissingPrefabChecker/Prefabs";
        private const string PrefabNameColor = "#00FF00";
        private const string SubPrefabNameColor = "#FF0000";

        [MenuItem("Tools/Examples/CheckMissingPrefab", priority = 7)]
